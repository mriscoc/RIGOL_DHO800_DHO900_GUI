.class public final Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;",
...
.field private final gridRulerView:Lcom/rigol/scope/views/grid/JitterBathtubCurveGridRulerView;
...
.method public constructor <init>(Landroid/content/Context;Lcom/rigol/scope/data/WindowParam;)V
    ...
    iput-object p1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->context:Landroid/content/Context;

    .line 3017
    new-instance p1, Lcom/rigol/scope/views/grid/JitterBathtubCurveGridRulerView;

    iget-object v2, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->context:Landroid/content/Context;
    ...
    .line 3017
    iput-object p1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->gridRulerView:Lcom/rigol/scope/views/grid/JitterBathtubCurveGridRulerView;

    .line 3021
    new-instance p1, Lcom/rigol/scope/views/baseview/BaseSurfaceView;

    iget-object v0, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->context:Landroid/content/Context;
    ...
    .line 3021
    iput-object p1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->surfaceView:Lcom/rigol/scope/views/baseview/BaseSurfaceView;
    ...
    .line 3029
    iget-object p2, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->gridRulerView:Lcom/rigol/scope/views/grid/JitterBathtubCurveGridRulerView;
    ...
    .line 3030
    iget-object p2, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->surfaceView:Lcom/rigol/scope/views/baseview/BaseSurfaceView;
    ...
    .line 3026
    iput-object p1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->content:Lcom/rigol/scope/views/window/WindowContent;

    .line 3034
    iget-object p1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->context:Landroid/content/Context;
    ...
    new-instance v0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$$special$$inlined$apply$lambda$1;

    invoke-direct {v0, p0}, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$$special$$inlined$apply$lambda$1;-><init>(Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;)V
    ...
    sget-object v0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$binding$1$2;->INSTANCE:Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$binding$1$2;
    ...
    iget-object v0, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->content:Lcom/rigol/scope/views/window/WindowContent;
    ...
    .line 3034
    iput-object p1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->binding:Lcom/rigol/scope/databinding/WindowSimpleBinding;

    .line 3047
    invoke-virtual {p0}, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->updateStatusText()V
    ...
    .line 3051
    new-instance v1, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$1;

    invoke-direct {v1, p0}, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$1;-><init>(Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;)V
    ...
    new-instance v2, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$2;

    invoke-direct {v2, p0}, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$2;-><init>(Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;)V
    ...
    new-instance p2, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$3;

    invoke-direct {p2, p0}, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder$3;-><init>(Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;)V
...
.method public static final synthetic access$getJitterParam$p(Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;)Lcom/rigol/scope/data/JitterParam;
    .locals 0

    .line 3012
    iget-object p0, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->jitterParam:Lcom/rigol/scope/data/JitterParam;

    return-object p0
.end method

.method public static final synthetic access$setJitterParam$p(Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;Lcom/rigol/scope/data/JitterParam;)V
    .locals 0

    .line 3012
    iput-object p1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->jitterParam:Lcom/rigol/scope/data/JitterParam;
...
.method public final getBinding()Lcom/rigol/scope/databinding/WindowSimpleBinding;
    ...
    .line 3033
    iget-object v0, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->binding:Lcom/rigol/scope/databinding/WindowSimpleBinding;
...
.method public updateTitle()V
    ...
    .line 3079
    iget-object v0, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->jitterParam:Lcom/rigol/scope/data/JitterParam;

    if-eqz v0, :cond_0

    .line 3080
    iget-object v1, p0, Lcom/rigol/scope/views/window/JitterBathtubWindowHolder;->binding:Lcom/rigol/scope/databinding/WindowSimpleBinding;
    ...
    const-string v4, "ViewUtil.getMappingObjec\u2026URVE.value1\n            )"
